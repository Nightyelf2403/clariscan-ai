...
[
    ...
    "customer may only terminate",
    "only terminate for material breach",
    "terminate only for cause",
    "terminate only after cure period",
    "other party may terminate",
    "one party may terminate",
    "company may terminate this agreement",
    "client may only terminate after",
    "sole right to terminate"
],
     "Termination rights are one-sided, granting one party broader or easier ability to terminate than the other.",
     "Negotiate for mutual and balanced termination rights, including equivalent notice and conditions."),
...
Rule("IMMEDIATE_TERMINATION", "critical_alert", "high",
     [
         ...
         "upon notice effective immediately"
     ],
...
Rule(
    ...
    "The agreement may end automatically based on time or conditions, without explicit action by you.",
    "Ensure renewal terms, reminders, and post-termination rights are clearly defined."
),
...
Rule("UNILATERAL_MODIFICATION", "critical_alert", "high",
     [
         ...
         "update this agreement at our discretion"
     ],
     "The agreement allows one party to change terms without the other's approval.",
     "Require advance written notice and explicit consent for any modifications."),
...
Rule("SERVICE_SUSPENSION", "critical_alert", "high",
    ...
    "company may suspend services",
    "temporarily suspend",
    "suspend without liability"
    ],
...
Rule("NO_REFUNDS", "critical_alert", "high",
     ...
     "Payments are non-refundable or final, limiting your ability to recover funds.",
     "Confirm refund conditions and evaluate the risk of non-recoverable payments."),
...
[
    ...
    "arising from client misuse",
    "client shall indemnify"
],
"Broad indemnification obligations may expose one party to significant third-party liability.",
"Limit indemnity scope, require fault-based triggers, and add caps where possible."),
...
"Ensure notice, mitigation duties, and termination rights are defined."),
...
Rule("NOTICE_PERIOD", "review_required", "medium",
     ...
     "Strict notice periods apply, which may delay termination or enforcement of rights.",
     "Calendar all notice deadlines and negotiate shorter or mutual notice periods where possible."),

Rule("FIXED_TERM_LENGTH", "review_required", "medium",
     [
     ...
     "The agreement locks the parties into a fixed multi-year term.",
     "Confirm early termination rights, renewal mechanics, and exit penalties."),

Rule("LATE_FEES", "review_required", "medium",
[
    "late payments shall incur",
    "late payment shall incur",
    "interest at",
    "interest per month",
    "2.5% per month",
...
"Late payment penalties and service suspension rights increase financial risk.",
"Confirm grace periods, cap interest rates, and require notice before suspending services."),
...
[
    "all intellectual property developed shall remain",
    "sole property of the company",
    "exclusive ownership",
    "work product ownership",
    "client receives a limited",
    "revocable non-transferable license"
],
"Intellectual property ownership is heavily skewed toward one party.",
"Limit ownership scope, exclude pre-existing IP, and define clear license boundaries."),
...
Rule("DATA_SHARING", "privacy_data", "high",
     [
         ...
         "data sharing",
         "provide your information to partners",
         "disclose personal data to affiliates"
     ],
     "Your data may be shared with third parties, partners, or affiliates.",
     "Limit data sharing, require explicit consent, and review privacy policies for third-party disclosures."),
...
"Liability is capped or excluded in ways that may significantly limit recovery.",
"Negotiate higher caps, carve-outs for gross negligence, and mutual liability terms."),
